...
class Av5_Correios_Model_Mysql4_Carrier_Correios extends Mage_Core_Model_Mysql4_Abstract {
    ...
    /**
     * Lista os servi�os que precisam de atualizam jundo com a quantidade de registros
     * desatualizados
    ...
    /**
     * Verifica se o servi�o est� presente no banco de dados
    ...
    /**
     * Atualiza o servi�o informado com os dados recebidos
     * @param int $id
     * @param array $data
     */
    ...
    /**
     * Popula o banco de dados com os dados padr�o para os servi�os informados
    		...
    		foreach ($this->_defaultData as $record) {
    			for($weight = 1; $weight <= $maxWeight; $weight++) {
	    			try {
	    				...
	    				Mage::log("AV5_Correios Erro: " . $e->getMessage() . " > Servi�o: " . $service[1] . "(" . $service[0] . ") - CEP:" . $record[1] . " a " . $record[2] . " - Peso: " . $weight);
	    			}
    			}
    		}
    	}
