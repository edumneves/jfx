...
<?php echo "<img src='" . Mage::getBaseUrl('skin') .  "/boletophp/imagens/boleto_linha_digitavel.php?boleto=". $dadosboleto["linha_digitavel"] . "' />"; ?>
...
<?php //echo $dadosboleto["linha_digitavel"]?>
<?php echo "<img src='" . Mage::getBaseUrl('skin') .  "/boletophp/imagens/boleto_linha_digitavel.php?boleto=". $dadosboleto["linha_digitavel"] . "' style='margin-bottom: 5px;'/>"; ?>
