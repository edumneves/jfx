...
ShippingMethod.prototype = {
    ...
    validate: function () {
        ...
        if (methods.length == 0) {
            OPC.Messenger.add(Translator.translate('Sua compra nÃ£o pode ser completada, pois nÃ£o hÃ¡ mÃ©todo de entrega disponÃ­vel, Ã© preciso preencher o endereÃ§o de entrega.'), 'checkout-shipping-method-load', 'error');
            return false
        }
        ...
        OPC.Messenger.add(Translator.translate('Escolha o mÃ©todo de entrega'), 'checkout-shipping-method-load', 'error');
        return false
    }
};
